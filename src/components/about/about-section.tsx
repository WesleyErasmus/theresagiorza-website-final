...
export default function AboutSection() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sage-50 to-cream-50">
          ...
          >
            ...
            <div className="prose prose-lg text-stone-800 space-y-4">
              ...
              <p>
                ...
                fuga nisi ipsam tenetur provident harum, dolorum voluptates esse
                voluptas incidunt quidem reprehenderit dolores iusto corrupti
                blanditiis exercitationem eligendi at! Error accusantium illum
                sed. Eaque alias error magnam sunt, quasi consequatur.
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
